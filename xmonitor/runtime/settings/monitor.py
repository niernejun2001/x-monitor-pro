...
def load_monitor_runtime_settings(env):
    ...
    return {
        ...
        'NOTIFICATION_SCAN_INTERVAL_MIN_SEC': _safe_float(env.get('XMONITOR_NOTIFY_SCAN_MIN_SEC', '3'), 3.0),
        'NOTIFICATION_SCAN_INTERVAL_MAX_SEC': _safe_float(env.get('XMONITOR_NOTIFY_SCAN_MAX_SEC', '6'), 6.0),
        ...
        'NOTIFICATION_REFRESH_INTERVAL_MIN_SEC': _safe_float(env.get('XMONITOR_NOTIFY_REFRESH_MIN_SEC', '20'), 20.0),
        'NOTIFICATION_REFRESH_INTERVAL_MAX_SEC': _safe_float(env.get('XMONITOR_NOTIFY_REFRESH_MAX_SEC', '40'), 40.0),
        ...
        'NOTIFICATION_REFRESH_COOLDOWN_PROB': _safe_float(env.get('XMONITOR_NOTIFY_REFRESH_COOLDOWN_PROB', '0.16'), 0.16),
        'NOTIFICATION_REFRESH_COOLDOWN_MIN_SEC': _safe_float(env.get('XMONITOR_NOTIFY_REFRESH_COOLDOWN_MIN_SEC', '8'), 8.0),
        'NOTIFICATION_REFRESH_COOLDOWN_MAX_SEC': _safe_float(env.get('XMONITOR_NOTIFY_REFRESH_COOLDOWN_MAX_SEC', '22'), 22.0),

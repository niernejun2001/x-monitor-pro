...
class RuntimeState:
    ...
    notification_next_refresh_at: float = 0.0
    notification_scan_interval: float = 0.0
    notification_last_scan_at: float = 0.0
    notification_next_scan_at: float = 0.0
    notification_tab_ready_at: float = 0.0
    notification_scan_preflight_deadline_at: float = 0.0
    notification_empty_article_streak: int = 0
    notification_last_new_item_at: float = 0.0
    notification_idle_scan_streak: int = 0
...
def build_runtime_state(module):
    return RuntimeState(
        ...
        notification_next_refresh_at=float(getattr(module, 'notification_next_refresh_at', 0.0) or 0.0),
        notification_scan_interval=float(getattr(module, 'notification_scan_interval', 0.0) or 0.0),
        notification_last_scan_at=float(getattr(module, 'notification_last_scan_at', 0.0) or 0.0),
        notification_next_scan_at=float(getattr(module, 'notification_next_scan_at', 0.0) or 0.0),
        notification_tab_ready_at=float(getattr(module, 'notification_tab_ready_at', 0.0) or 0.0),
        notification_scan_preflight_deadline_at=float(getattr(module, 'notification_scan_preflight_deadline_at', 0.0) or 0.0),
        notification_empty_article_streak=int(getattr(module, 'notification_empty_article_streak', 0) or 0),
        notification_last_new_item_at=float(getattr(module, 'notification_last_new_item_at', 0.0) or 0.0),
        notification_idle_scan_streak=int(getattr(module, 'notification_idle_scan_streak', 0) or 0),
